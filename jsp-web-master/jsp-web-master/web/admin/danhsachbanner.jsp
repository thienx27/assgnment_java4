                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><%= bn.getUrl()%></td>
                                        <td>
                                            <a href="suabanner.jsp?action=Update Banner&MaBN=<%= bn.getMaBN()%>">Sửa</a> &nbsp;/ 
                                            <a href="/KTT_-_SHOP/AdController?action=Delete Banner&MaBN=<%= bn.getMaBN()%>" onclick="return confirm('Bạn có chắc xóa khách hàng này?')">Xóa</a>
                                        </td>
                                    </tr>
                                    <%
                                        i++;
